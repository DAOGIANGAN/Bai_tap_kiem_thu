...
import sys
from Kiem_thu_dong_du_lieu import Total  # Import hàm từ file chính

@pytest.mark.parametrize("day, quantity, total, expected_output", [
    ("3/3", 1, -1, "Gia tri dau vao khong hop le!\n"),
    ("3/3", -1, 1, "Gia tri dau vao khong hop le!\n"),
    ("3/3", 1, 1, "Khong phai ngay giam gia! Tong hoa don: 1 dong\n"),
    ("14/2", 3, 2000000, "Tong hoa don: 1800000 dong\n"),
    ("14/2", 4, 900000, "Tong hoa don: 810000 dong\n"),
    ("14/2", 4, 2000000, "Tong hoa don: 1600000 dong\n"),
])
